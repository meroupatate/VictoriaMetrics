...
* FEATURE: [vmagent](https://docs.victoriametrics.com/victoriametrics/vmagent/): limit the number of parse error logs per scrape response. See [#8856](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/8856).
